(() => {
    ...
    (() => {
        ...
        core_getElement(".modal__body", modal || document);
        ...
        function projects() {
            if (!core_getElement('[data-swiper="projects"]')) return;
        ...
        function advantages() {
            if (!core_getElement('[data-swiper="advantages"]')) return;
        ...
        class Modal {
            ...
            attachModalCloseBtns() {
                if (this.modal.querySelector("[data-modal-close]")) this.modal.querySelectorAll("[data-modal-close]").forEach((closeBtn => {
                    closeBtn.addEventListener("click", (() => {
                        this.closeModal(this.modal);
                    }));
                }));
            ...
            closeModal() {
                ...
                if (!this.static) setTimeout((() => {
                    core_getElement(".modal__content .wrapper", this.modalBody).innerHTML = ``;
                }), 250);
            }
            detachModalEvents() {
                if (this.modal.querySelector(".modal__close")) this.modal.querySelectorAll(".modal__close").forEach((closeBtn => {
        ...
        class Form {
            ...
            checkEmailInput(input) {
                ...
                input.addEventListener("blur", (() => {
                    ...
                    core_getElement(".form__message", input.closest(".form__item")).innerHTML = isValid ? "" : templateEmail;
                }));
                input.addEventListener("input", (() => {
                    this.valid(input);
                    core_getElement(".form__message", input.closest(".form__item")).innerHTML = "";
                }));
            }
        ...
        function updateSwiperSlides() {
            ...
            if (window.innerWidth < 1024) Array.from(slides).forEach((slide => {
                slide.classList.add("swiper-slide");
            })); else Array.from(slides).forEach((slide => {
